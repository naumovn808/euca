...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config */ "./map/config.js");
...
class Map {
  ...
  async init() {
    ...
    this.setCustomTheme(_config__WEBPACK_IMPORTED_MODULE_0__.config.CUSTOM_THEME);
    this.map.addChild(new this.YMapDefaultFeaturesLayer());
    this.setMarker(this.center);
    this.zoomControl = new YMapZoomControl({});
    this.map.addChild(
      new this.YMapControls({ position: "right" }).addChild(this.zoomControl)
    );
    this.setupCtrlZoom();
